...
export default function App() {
  return (
    <div className="bg-gradient-to-b from-background to-secondary/30 flex flex-col" style={{ height: '100%' }}>
      {/* Hero Section - Expands to fill available space */}
      <section className="flex flex-col justify-center py-20 md:py-32" style={{ flex: '1 1 0px' }}>
      ...
      {/* Bottom sections - Always at bottom of viewport */}
      <div className="flex-shrink-0">
        ...
        <footer className="border-t border-border">
          <div className="container mx-auto px-4 sm:px-6" style={{ paddingTop: '1.25rem', paddingBottom: '1.25rem' }}>
